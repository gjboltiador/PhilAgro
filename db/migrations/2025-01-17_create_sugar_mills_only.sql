-- Migration: Create Sugar Mills Table and Sample Data
-- This script creates the sugar mills table and inserts comprehensive sample data
...
-- 5. Display sample sugar mill data for verification
SELECT 
  plant_code,
  short_name,
  city,
...
SELECT 'Sugar Mills table and sample data created successfully' as status;
